...
/***/ function(module, exports, __webpack_require__) {
	...
	var Base = function (_Component) {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.value !== this.props.value || nextProps.validations !== this.props.validations) {
	                this.setState({
	                    value: nextProps.value,
	                    isChanged: true
	                }, function () {
	                    _this2.context.register(_this2);
	...
	Base.propTypes = {
	    ...
	    validations: _react.PropTypes.arrayOf(_react.PropTypes.string),
...
/***/ function(module, exports, __webpack_require__) {
	...
	Button.contextTypes = {
	    errors: _react.PropTypes.objectOf(_react.PropTypes.arrayOf(_react.PropTypes.node))
	};
	...
	var Input = function (_Base) {
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            ...
	            var error = void 0;
	            if (isInvalid && _typeof(this.context.errors[this.props.name][0]) === 'object') {
	                error = this.context.errors[this.props.name][0];
	            } else if (isInvalid) {
	                error = _rules2.default[this.context.errors[this.props.name][0]].hint(this.state.value, this.context.components);
	            }
